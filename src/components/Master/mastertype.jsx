    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <div className="p-4 md:p-8 max-w-3xl mt-24 mx-auto w-full flex-grow">
                <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">Create Resource Type</h2>
                ...
                <div className="bg-white shadow-lg rounded-2xl p-8">
                    <form className="grid grid-cols-1 gap-8" onSubmit={handleSubmit}>
                        <div className="flex flex-col gap-2">
                            ...
                            <label htmlFor="resourceClassId" className="font-semibold mt-6 text-gray-700">
                                Resource Class Name
                            </label>
                            <input
